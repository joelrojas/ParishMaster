...
class fiel
{
    ...
    {
        $q="select nombre, apellido from persona where idpersona=".$id;         //CAMBIAR QUE SI ES NUL RETORNE NOMBRE = ERROR PARA PONER ALARMA
        //$res=$this->dbh->exequery($q);
        //if(!$res) die('Invalid query'.mysql_error());
        $res=array('nombre' =>"Maria" , 'apellido' =>"Lopez");
        $this->fill($res);
    }
