...
$c= new certificado('',"","","","");
$res=$c->get_comunion_info($_SESSION['idPersona']);
      ...
      <div class='container'>
        <div class='row'>
          <div class='col-md-12'>
            ...
            <h4 class='text-center'><b> ".strtoupper($fila['parroquiacomunion'])."</b></h4>
            <br><br>
            <p class='text-center cert'>El ".$tiposac." ".$fila['nombrecertificante']." ".$fila['apellidocertificante']." "." &nbsp;de la ".$fila['parroquiacomunion']." CCERTIFICA que:
              <br>
